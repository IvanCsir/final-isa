...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'kookily per pants', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2024-07-22T08:03:12.796Z' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('er unexpectedly');
      cy.get(`[data-cy="title"]`).should('have.value', 'er unexpectedly');
      ...
      cy.get(`[data-cy="date"]`).type('2024-07-22T03:26');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2024-07-22T03:26');
